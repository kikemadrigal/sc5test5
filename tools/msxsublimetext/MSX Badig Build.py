...
msxbadig_filepath = '.\tools\msxbadig\msxbadig.exe'      # Path to MSX Basic Dignified ('' = local path)
batoken_filepath = '.\tools\msxbatoken\msxbatoken.exe'       # Path to MSX Basic Tokenizer ('' = local path)
openbatoken_filepath = ''   # Path to openMSX Basic Tokenizer ('' = local path)
openmsx_filepath = '.\tools\emulators\openmsx\openmsx.exe'       # Path to openMSX ('' = local path)
machine_name = 'Philips_NMS_8255'           # openMSX machine to open, eg: 'Sharp_HB-8000_1.2' 'Sharp_HB-8000_1.2_Disk' 'Philips_NMS_8250'
disk_ext_name = 'objects'          # openMSX extension to open, eg: 'Microsol_Disk:SlotB'
